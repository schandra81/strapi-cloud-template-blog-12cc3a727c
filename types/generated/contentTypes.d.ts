...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    faqItems: Schema.Attribute.Component<'blog.faq', true>;
    featuredImage: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCityIndustryPageCityIndustryPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'city_industry_pages';
  info: {
    description: '';
    displayName: 'City Industry Page';
    pluralName: 'city-industry-pages';
    singularName: 'city-industry-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    comboFAQs: Schema.Attribute.Component<'city-industry.faq', true>;
    comboIntro: Schema.Attribute.RichText;
    contentStatus: Schema.Attribute.Enumeration<
      ['needs-content', 'ai-draft', 'human-reviewed', 'published']
    > &
      Schema.Attribute.DefaultTo<'needs-content'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    nearbyComboPages: Schema.Attribute.Relation<
      'manyToMany',
      'api::city-industry-page.city-industry-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    uniqueWordCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cityIndustryPages: Schema.Attribute.Relation<
      ...
      'api::city-industry-page.city-industry-page'
    >;
    complianceNotes: Schema.Attribute.RichText;
    contentStatus: Schema.Attribute.Enumeration<
      ['needs-content', 'ai-draft', 'human-reviewed', 'published']
    > &
      Schema.Attribute.DefaultTo<'needs-content'>;
    ...
    industryBodyContent: Schema.Attribute.RichText;
    industryFAQs: Schema.Attribute.Component<'industry.faq', true>;
    industryIntro: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::industry.industry'
